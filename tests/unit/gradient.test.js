...
describe('gradientText', () => {
  ...
  it('returns plain text when NO_COLOR is set', async () => {
    ...
    const result = gradientText('hello', [[255, 0, 0], [0, 0, 255]])
  ...
  it('returns empty string for empty input', async () => {
    ...
    expect(gradientText('', [[255, 0, 0], [0, 0, 255]])).toBe('')
  })
  ...
  it('phase shifts gradient offset', async () => {
    ...
    const result0 = gradientText('abc', [[255, 0, 0], [0, 0, 255]], 0)
    const result1 = gradientText('abc', [[255, 0, 0], [0, 0, 255]], 0.5)
