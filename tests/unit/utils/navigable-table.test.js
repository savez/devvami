...
describe('buildTableScreen', () => {
  it('renders without throwing and contains heading and footer attribution', () => {
    const state = createInteractiveTableState(
      [{ id: 'CVE-2024-0001', severity: 'High', score: '8.0', published: '2024-01-01', description: 'Test CVE', reference: 'https://example.com' }],
      [
    ...
    const plain = output.replace(/\x1b\[[0-9;]*m/g, '').replace(/\x1b\[2J/g, '').replace(/\x1b\[H/g, '')
